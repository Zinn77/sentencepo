...
def compute_policy_loss_sentencepo(
    ...
    pg_metrics: dict[str, Any] = {
        ...
        "sentencepo/sent_clip_fraction": pg_clipfrac.detach(),
        "sentencepo/mean_abs_delta_sent": delta_sent.abs().mean().detach(),
        "sentencepo/mean_c_sent": c_sent.mean().detach(),
        "sentencepo/ppl_sent_mean": ppl_sent.mean().detach(),
        "sentencepo/len_sent_mean": cnt.mean().detach(),
        "sentencepo/K_i_mean": sent_count.mean().detach(),
    }
