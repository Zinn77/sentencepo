...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset_name", default="Hothan/OlympiadBench")
    parser.add_argument("--config_name", default="OE_MM_maths_en_COMP")
    ...
    def process_fn(example, idx):
        ...
        data = {
            "data_source": f"{args.dataset_name}:{args.config_name}",
