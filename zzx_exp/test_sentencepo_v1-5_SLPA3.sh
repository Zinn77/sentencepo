...
slpa_topk_sim_sentences=${slpa_topk_sim_sentences:-3}
...
# 结果路径
TOT_DIR=$HOME/autodl-tmp/models_v1-5/sentencepo_${DS}_${MODEL_NAME}_ep${EPOCHS}_epsbase${sentencepo_eps_base}_slpa${slpa_enable}_topk${slpa_topk_sim_sentences}_scr${scr_enable}
mkdir -p $TOT_DIR
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    +algorithm.slpa.topk_sim_sentences=$slpa_topk_sim_sentences \
