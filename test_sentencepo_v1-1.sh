...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    +actor_rollout_ref.actor.policy_loss.sentencepo.min_sent_tokens=$sentencepo_min_sent_tokens \
    +actor_rollout_ref.actor.policy_loss.sentencepo.eps_base=$sentencepo_eps_base \
    +actor_rollout_ref.actor.policy_loss.sentencepo.lambda_ppl=$sentencepo_lambda_ppl \
    +actor_rollout_ref.actor.policy_loss.sentencepo.lambda_len=$sentencepo_lambda_len \
    +actor_rollout_ref.actor.policy_loss.sentencepo.cmin=$sentencepo_cmin \
    +actor_rollout_ref.actor.policy_loss.sentencepo.cmax=$sentencepo_cmax \
    +actor_rollout_ref.actor.policy_loss.sentencepo.stats_eps=$sentencepo_stats_eps \
